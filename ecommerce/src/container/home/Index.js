...
const Index = () => {
  ...
  console.log("User ID shopping cart:", userId);
  useEffect(() => {
            ...
            <div className="row mb-4">
              <div className="col-lg-3 col-md-6">
                ...
                >
                  ...
                  <figcaption className="info">
                    <h6 className="title">Vận chuyển miễn phí</h6>
                    <p>Freeship cho mọi đơn hàng ở Hà Nội</p>
                  </figcaption>
                </figure>
                {/* itemside // */}
              </div>
              ...
              <div className="col-lg-3 col-md-6">
                ...
                >
                  ...
                  <figcaption className="info">
                    <h6 className="title">Hầng hiệu 100%</h6>
                    ...
                    <div className="card-body d-flex flex-column">
                      ...
                      >
                        <a
                          ...
                          onClick={() =>
                            addToCart(product.id, userId , product.price)
                          }
                        >
                          Add to cart
                        </a>
